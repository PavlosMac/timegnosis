...
This file provides guidance to AI coding assistants (Cursor, GitHub Copilot, etc.) when working with this repository.
...
- **Data**: Local JSON files (`gnosis-seed.json`, `planets-seed.json`)
- **Editor**: Draft.js-based content management
